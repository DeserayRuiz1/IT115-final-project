...
if ($_POST['comments'] == 'Please share any comments you have here') $_POST['comments'] = 'Suggestions/Feedback';	
...
mail ('Deseray.Ruiz@seattlecolleges.com', $subject, $body, $from);

header('Location: http://compass.northseattle.edu/~druiz/it111/final/thx.html'); // replace "thx.html" with the name and path to your actual thank you page